...
typedef uint32 TagArgPtr;
typedef uint32 TagArgPtrPtr;

typedef void List;
typedef void TagArg;

//*****new typedef*****//
typedef uint32 LookupPtr;
typedef uint32 CheckPtr;
typedef uint32 FolioPtr;
typedef uint32 IOInfoPtr;
typedef uint32 MsgPtr;
typedef uint32 TimeValPtr;
typedef uint32 IOReqPtr;
typedef uint32 SetFuncPtr;
